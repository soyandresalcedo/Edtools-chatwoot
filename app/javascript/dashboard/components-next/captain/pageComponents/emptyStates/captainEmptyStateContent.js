...
export const documentsList = [
  {
    ...
    id: 3059,
    name: 'How to use Conversation Filters? | User Guide | Edtools',
    status: 'available',
  },
  {
    account_id: 2,
    ...
    id: 3060,
    name: 'Automating Ticket Assignments | User Guide | Edtools',
    status: 'available',
  },
  {
    account_id: 3,
    ...
    external_link:
      'https://www.edtools.co/hc/user-guide/articles/1677688210-managing-customer-profiles',
    id: 3061,
    name: 'Managing Customer Profiles | User Guide | Edtools',
    status: 'available',
  },
  {
    account_id: 4,
    ...
    external_link:
      'https://www.edtools.co/hc/user-guide/articles/1677688220-sales-tracking-guide',
    id: 3062,
  ...
  },
  {
    ...
    content:
      'How to efficiently create, manage, and resolve tickets in Edtools.',
    created_at: 1736143276,
    external_link:
      'https://www.edtools.co/hc/user-guide/articles/1677688230-managing-tickets',
    id: 3063,
  ...
  },
  {
    ...
    external_link:
      'https://www.edtools.co/hc/user-guide/articles/1677688240-financial-reporting',
    id: 3064,
    name: 'Financial Reporting | User Guide | Edtools',
    status: 'available',
  },
];
...
export const responsesList = [
  {
    ...
    id: 87,
    question: 'Why is my Messenger in Edtools deactivated?',
    status: 'pending',
    assistant: {
      account_id: 1,
      config: { product_name: 'Edtools' },
  ...
  },
  {
    ...
    id: 89,
    question: 'How can I reset my password in Edtools?',
    assistant: {
      account_id: 3,
      config: { product_name: 'Edtools' },
  ...
  },
  {
    ...
    id: 90,
    question: 'How do I enable dark mode in Edtools?',
    assistant: {
      account_id: 4,
      config: { product_name: 'Edtools' },
  ...
  },
  {
    ...
    id: 91,
    question: 'How do I add a new team member in Edtools?',
    assistant: {
      account_id: 5,
      config: { product_name: 'Edtools' },
  ...
  },
  {
    account_id: 6,
    answer:
      "Campaigns in Edtools allow you to send targeted messages to specific user segments. You can create them in the 'Campaigns' section.",
    created_at: 1736283380,
    id: 92,
    question: 'What are campaigns in Edtools?',
    assistant: {
      account_id: 6,
      config: { product_name: 'Edtools' },
