export default [
  {
    additionalAttributes: {
      ...
      description:
        "I'm Laura, a developer focusing on building web solutions. Currently, I’m working as a Product Developer at Chatwoot.",
      companyName: 'Edtools',
      countryCode: 'US',
      socialProfiles: {
        github: 'edtools-laura',
        twitter: 'edtools-laura',
        facebook: 'edtools-laura',
        linkedin: 'edtools-laura',
        instagram: 'edtools-laura',
      },
    },
    availabilityStatus: 'offline',
    email: 'laura@edtools.co',
    id: 22,
  ...
  },
  {
    additionalAttributes: {
      city: 'Miami',
      country: 'United States',
      description: 'Entrepreneur with a background in edtech.',
